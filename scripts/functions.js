function copy_to_clipboard(text)
{
    ...
    else
    {
        ...
        clipboarddiv.innerHTML='<embed src="/maps/clipboard.swf" FlashVars="clipboard='+
            encodeURIComponent(text)+'" width="0" height="0" type="application/x-shockwave-flash"></embed>';
    }
    alert('The location is copied to your clipboard...');
    return false;
}
...
$(function() {
   ...
   //$(searchGo).attr("disabled", "disabled"); // To disable 
$(function() {
...
var searchGo = $("#searchgo"); 
// Disable search button until match
